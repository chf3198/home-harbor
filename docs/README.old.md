...
### Phase 1: Backend ✅
- [x] Real data integration (CT sales + Google Street View)
- [x] Search & filtering
- [x] Sorting & pagination
- [x] 95%+ test coverage
- [x] AI architecture design (OpenRouter + Molmo2-8B vision)

### Phase 2: AI Integration ⏳ **IN PROGRESS**
- [x] OpenRouter LLM architecture
- [x] Vision analysis pipeline design
- [x] Google Street View integration plan
- [ ] OpenRouter client implementation (TDD)
- [ ] Molmo2-8B vision service
- [ ] Chat assistant interface
- [ ] Property photo augmentation
...
### Phase 4: Frontend ⏳
- [ ] React application
- [ ] Property listing UI with AI insights
- [ ] Search filters + vision filters
